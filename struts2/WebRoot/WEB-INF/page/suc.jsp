...
<body>
	<table>
		...
		<tr>
			<td>城市：</td>
			<td>
				<s:property value="#request.selectedcity.cityValue"/>
			</td>
		</tr>
		<tr>
			<td>爱好：</td>
			...
			<s:if test="#request.lstHobby!=null">
				<s:iterator value="#request.selectedhobbies" var="hobby" status="index" begin="0" end="#request.selectedhobbies.length-1">
					第[<s:property value="index+1"/>]条爱好：<s:property value="#hobby.hobbyValue"/><br/>
				</s:iterator>
			</s:if>
			</td>
		</tr>
